...
function GridItem({isLast,id,data}) {
    ...
    return (
        <Card  loading={loading} bordered={false} style={{zIndex:-3,backgroundColor:"transparent"}} bodyStyle={{backgroundColor:"transparent",borderRight: !isLast && "1px solid white"}}>
